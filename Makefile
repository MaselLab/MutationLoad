HOME_DIR = /home/u23/sarveshbaheti

CC = gcc
INCLUDES = -I$(HOME_DIR)/tskit/c -I$(HOME_DIR)/tskit/c/subprojects/kastore/
CFLAGS = $(INCLUDES) -O3 -frounding-math

mutationload: main.o dependencies/pcg_basic.o sharedfunc_flag.o relative_functions.o $(HOME_DIR)/tskit/c/tskit/tables.o $(HOME_DIR)/tskit/c/subprojects/kastore/kastore.o $(HOME_DIR)/tskit/c/tskit/core.o $(HOME_DIR)/tskit/c/tskit/genotypes.o $(HOME_DIR)/tskit/c/tskit/trees.o
	$(CC) -O3 -frounding-math pcg_basic.o main.o sharedfunc_flag.o relative_functions.o tables.o kastore.o core.o genotypes.o trees.o -lm -lgsl -lgslcblas -o mutationload
main.o: main.c
	$(CC) $(CFLAGS) -c main.c
